...
//     version 1.19.0
//     from Assets/Inputs/Map Input Actions.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Inputs/Map Input Actions.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""version"": 1,
    ""name"": ""Map Input Actions"",
    ""maps"": [
        {
            ""name"": ""Camera"",
            ""id"": ""180d9a3d-3bdd-4ee1-9cd2-e36bf5f2e0b5"",
            ""actions"": [
                {
                    ""name"": ""Zoom"",
                    ""type"": ""PassThrough"",
                    ""id"": ""9a161863-e1ae-4416-9ab9-6ebbdbcd5eee"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""053c8c32-5d12-441c-a342-f17d756c1274"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""3b4b615d-e094-45a9-8446-196c7f77acae"",
                    ""path"": ""<Mouse>/scroll/y"",
                    ""interactions"": """",
                    ""processors"": """",
    ...
    ""controlSchemes"": [
        ...
        ~@MapInputActions()
        {
            UnityEngine.Debug.Assert(!m_Camera.enabled, "This will cause a leak and performance issues, MapInputActions.Camera.Disable() has not been called.");
        }
        ...
        public struct CameraActions
        {
            ...
            /// </summary>
            public CameraActions(@MapInputActions wrapper) { m_Wrapper = wrapper; }
            /// <summary>
